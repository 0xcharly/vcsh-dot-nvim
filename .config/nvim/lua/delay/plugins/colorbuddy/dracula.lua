return function()
  ...
  vim.g.terminal_color_0 = '#454158'
  vim.g.terminal_color_8 = '#7970a9'
  ...
  Color.new('fgMuted', palette.subtle)
  Color.new('fgOnEmphasis', palette.fg)
  Color.new('whitespace', palette.dark_grey)

  Color.new('canvas', palette.bg)
  Color.new('gutterBg', palette.bg)
  Color.new('selectionBg', palette.selection)
  Color.new('activeLineBg', palette.bg_light)

  Color.new('border', palette.bg_light)
  Color.new('cursor', palette.fg)

  Color.new('lineNr', palette.subtle)
  Color.new('lineNrCursor', palette.fg)

  Color.new('hl', palette.comment)

  -- Roles.
  Color.new('roleNeutral', '#ffffff')
  Color.new('roleNeutralBg', palette.bg_light)
  Color.new('roleAccent', palette.purple)
  Color.new('roleAccentBg', palette.bg_light)
  Color.new('roleSuccess', palette.green)
  Color.new('roleSuccessBg', palette.bg_light)
  Color.new('roleAttention', palette.yellow)
  Color.new('roleAttentionBg', palette.bg_light)
  Color.new('roleSevere', palette.orange)
  Color.new('roleSevereBg', palette.bg_light)
  Color.new('roleDanger', palette.red)
  Color.new('roleDangerBg', palette.bg_light)
  Color.new('roleURI', palette.cyan)

  -- Syntax.
  Color.new('syntaxComment', palette.comment)
  Color.new('syntaxConstant', palette.purple)
  Color.new('syntaxFunction', palette.green)
  Color.new('syntaxEntity', palette.cyan)
  Color.new('syntaxEntityTag', palette.pink)
  Color.new('syntaxEntityTagAttribute', palette.cyan)
  Color.new('syntaxKeyword', palette.pink)
  Color.new('syntaxLiteral', palette.pink)
  Color.new('syntaxPreprocessor', palette.purple)
  Color.new('syntaxPunctuation', palette.fg)
  Color.new('syntaxString', palette.yellow)
  Color.new('syntaxType', palette.cyan)
  Color.new('syntaxVariable', palette.fg)

  Color.new('syntaxSpecial', palette.orange)
  Color.new('syntaxParam', palette.orange)

  -- Popup menu.
  Color.new('pmenuBg', palette.bg_light)
  Color.new('pmenuBorder', palette.bg_lighter)
  Color.new('pmenuSelect', palette.selection)
  Color.new('pmenuSbar', palette.bg_lighter)

  -- Diff.
  Color.new('diffAdd', palette.green)
  Color.new('diffAddSign', palette.green)
  Color.new('diffAddLineBg', palette.bg_light)
  Color.new('diffChange', palette.purple)
  Color.new('diffChangeSign', palette.purple)
  Color.new('diffChangeLineBg', palette.bg_light)
  Color.new('diffDelete', palette.red)
  Color.new('diffDeleteSign', palette.red)
  Color.new('diffDeleteLineBg', palette.bg_light)
  ...
  Group.new('TSTagAttribute', c.syntaxEntityTagAttribute) -- HTML tag attributes.
